...
def generate_args(data_path, fileName = '*.png', dims = 'XY', baseDir = 'models', name = 'N2V',
                  validationFraction = 5.0, patchSizeXY=64, patchSizeZ=64, epochs=100, stepsPerEpoch = 400,
                  batchSize = 64, netDepth=2, netKernelSize=3, n2vPercPix=1.6, learningRate = 0.0004,
                  unet_n_first = 32):
    '''
    ...
    '''
    args = {}
    args["baseDir"] = baseDir  # help="base directory in which your network will live"
    args["name"] = name  # help="name of your network"
    args["dataPath"] = data_path  # help="The path to your training data"
    args["fileName"] = fileName  # help="name of your training data file"
    args["validationFraction"] = validationFraction # help="Fraction of data you want to use for validation (percent)"
    args["dims"] = dims  # help="dimensions of your data, can include: X,Y,Z,C (channel), T (time)"
    args["patchSizeXY"] = patchSizeXY  # help="XY-size of your training patches"
    args["patchSizeZ"] = patchSizeZ  # , help="Z-size of your training patches"
    args["epochs"] = epochs  #  help="number of training epochs"
    args["stepsPerEpoch"] = stepsPerEpoch  # help="number training steps per epoch"
    args["batchSize"] = batchSize  # help="size of your training batches"
    args["netDepth"] = netDepth  # help="depth of your U-Net"
    args["netKernelSize"] = netKernelSize  # help="Size of conv. kernels in first layer"
    args["n2vPercPix"] = n2vPercPix  # help="percentage of pixels to manipulated by N2V"
    args["learningRate"] = learningRate  # help="initial learning rate"
    args["unet_n_first"] = unet_n_first  # help="number of feature channels in the first u-net layer"
